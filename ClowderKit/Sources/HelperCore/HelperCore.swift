...
public enum ChargeControl {
    public static func action(
        level: Int, target: Int, isInhibited: Bool,
        hysteresis: Int = 3
    ) -> ChargeAction {
...
public enum WatchdogLogic {
    public static func shouldRestoreFans(
        lastHeartbeat: Date, now: Date, fansManual: Bool,
        timeout: TimeInterval = HelperConstants.watchdogTimeout
    ) -> Bool {
